...
from giant_learning.poly_poly import SphericalH4H4Overlaps, H4H4Overlaps
...
target = H4H4Overlaps._target
activation = H4H4Overlaps._activation
activation_derivative = H4H4Overlaps._activation_derivative
nseeds = 1
ds = np.logspace(9,11,base=2,num=3,dtype=int)
...
for i,d in enumerate(ds):
    ...
    for seed in range(nseeds):
        ...
        gd = SphericalGradientDescent(
            ...
            test_size = None, analytical_error= 'H4H4'
        )
